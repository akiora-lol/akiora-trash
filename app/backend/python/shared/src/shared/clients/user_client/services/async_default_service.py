...
async def HealthHealth(api_config_override: Optional[APIConfig] = None) -> None:
...
async def UsersCreateUser(
    api_config_override: Optional[APIConfig] = None, *, user_uc: Any, data: UserCreate
) -> UserResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def UsersUserIdGetUser(
    api_config_override: Optional[APIConfig] = None, *, user_uc: Any, user_id: str
) -> UserResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def UsersUserIdDeleteUser(api_config_override: Optional[APIConfig] = None, *, user_uc: Any, user_id: str) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def UsersUserIdUpdateUser(
